      ...
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-4">
            ...
            <Button
              variant="default"
              className="w-full h-12 bg-[#1a1a1a] hover:bg-[#2a2a2a] gap-3"
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <button
                onClick={onRegister}
                className="text-[#289B5F] hover:underline"
              >
                Regístrate
              </button>
            </p>
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="space-y-6">
          ...
          <button className="text-sm text-[#289B5F] hover:underline">
            ¿Olvidaste tu contraseña?
          </button>

          <Button
            className="w-full h-12 bg-[#289B5F] hover:bg-[#289B5F]/90"
